...
public class OgmPersisterClassResolverTest {
	...
	public void testRootSingleTableStrategy() throws Exception {
		assertThat( resolver.getEntityPersisterClass( rootMetadata(InheritanceType.SINGLE_TABLE) ) ).isEqualTo( OgmEntityPersister.class );
	}
	...
	public void testRootTablePerClassStrategy() throws Exception {
		assertThat( resolver.getEntityPersisterClass( rootMetadata(InheritanceType.TABLE_PER_CLASS) ) ).isEqualTo( OgmEntityPersister.class );
	}

	@Test
	public void testSubclassTablePerClassStrategy() throws Exception {
		assertThat( resolver.getEntityPersisterClass( subclassMetadata(InheritanceType.TABLE_PER_CLASS) ) ).isEqualTo( UnionSubclassOgmEntityPersister.class );
	}

	@Test
	public void testRootJoinedStrategy() throws Exception {
		assertThat( resolver.getEntityPersisterClass( rootMetadata(InheritanceType.JOINED) ) ).isEqualTo( OgmEntityPersister.class );
	}
	...
	public void testNoInheritanceStrategy() throws Exception {
		assertThat( resolver.getEntityPersisterClass( rootMetadata(InheritanceType.NO_INHERITANCE) ) ).isEqualTo( OgmEntityPersister.class );
	}

	@Test
	public void testPersistentRootSingleTableStrategy() throws Exception {
		RootClass rootClass = new RootClass();
		assertThat( resolver.getEntityPersisterClass( rootClass ) ).isEqualTo( OgmEntityPersister.class );
	}
	...
	public void testSinglePersistentClassTableStrategy() throws Exception {
		...
		assertThat( resolver.getEntityPersisterClass( subclass) ).isEqualTo( OgmEntityPersister.class );
	}
