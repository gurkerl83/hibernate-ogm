/*
 * Hibernate, Relational Persistence for Idiomatic Java2
 *
...
public class TimestampDateTypeDescriptorTest {
	...
	public void testConversionToString() throws Exception {
		assertThat( TimestampDateTypeDescriptor.INSTANCE.toString( createDate( 5 ) ) ).matches(
				"2113/08/05 21:58:39:777.*" );
	}
