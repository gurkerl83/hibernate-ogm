 ...
 */
class ColumnDiscriminator implements EntityDiscriminator {
	...
	public ColumnDiscriminator(final PersistentClass persistentClass, final SessionFactoryImplementor factory, final Column column) {
